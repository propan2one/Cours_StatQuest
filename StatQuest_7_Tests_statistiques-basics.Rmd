...
Pour toute variable aléatoire, il est possible de définir une fonction qui permet de représenter une loi de probabilité sous forme d'intégrales. Cette fonction permet alors de déterminer la probabilité pour