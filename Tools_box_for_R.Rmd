...
Voir cette [partie](#creation-dataset) pour la création de dataframe plus précise
...
# Dataset
## Creation dataset : 
### Création dataframe à partir d'une série de vecteurs
```{r}
donnees <- data.frame(A=c(18,17,17,17,12,5,10,8), B=c(8,12,15,10,1,5,20,7), C=c(18,15,16,14,13,17,15,15), D=c("rouge", "jaune"))
```
