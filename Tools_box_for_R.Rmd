...
df <- read.table("~/Document/exemples/donneAimporter.txt", header = FALSE, dec = ".", sep = "\t", stringsAsFactors=F)
df
```
...
```{r}
noms_long <- "~/Documents/private_AF11-I-T48_intersec_3_replicats.csv"
all_data$condition <- as.factor(sub("\\.", "", all_data$condition)) # remove a dot without using pattern
